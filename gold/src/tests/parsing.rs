...
fn lists() {
    ...
    assert_eq!(parse("[1,]"), Ok(Expr::list(vec![1.lel(1),]).tag(0..4)),);
...
#[test]
fn unary_operators() {
    assert_eq!(parse("-1"), Ok(1.expr(1).neg(0).tag(0..2)),);
...
#[test]
fn power_operators() {
    assert_eq!(parse("2^3"), Ok(2.expr(0).pow(3.expr(2), 1).tag(0..3)),);
...
#[test]
fn operators() {
    assert_eq!(parse("1 + 2"), Ok(1.expr(0).add(2.expr(4), 2).tag(0..5)),);
    ...
    assert_eq!(parse("1 < 2"), Ok(1.expr(0).lt(2.expr(4), 2).tag(0..5)),);
